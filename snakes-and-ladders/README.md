[Discussion Post (created on 14/8/2021 at 14:27)](https://leetcode.com/problems/snakes-and-ladders/discuss/1462852/C%2B%2B-or-BFS)  
<h2>909. Snakes and Ladders</h2><h3>Medium</h3><hr><div><p>You are given an <code>n x n</code> integer matrix <code>board</code> where the cells are labeled from <code>1</code> to <code>n<sup>2</sup></code> in a <a href="https://en.wikipedia.org/wiki/Boustrophedon" target="_blank"><strong>Boustrophedon style</strong></a> starting from the bottom left of the board (i.e. <code>board[n - 1][0]</code>) and alternating direction each row.</p>
