<h2>982. Triples with Bitwise AND Equal To Zero</h2><h3>Hard</h3><hr><div><p>Given an array of integers <code>nums</code>, find the number of&nbsp;triples of indices (i, j, k)&nbsp;such that:</p>
