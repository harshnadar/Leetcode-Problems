<h2>903. Valid Permutations for DI Sequence</h2><h3>Hard</h3><hr><div><p>You are given a string <code>s</code> of length <code>n</code> where <code>s[i]</code> is either:</p>
